...
macOS 14+ 原生刘海待办工具。收起时显示在刘海右侧（🐟 emoji 装饰，轻微游漂动画），点击或按快捷键展开双列任务看板。

## 功能特性

### 核心功能

- **刘海贴合式胶囊**：收起时显示在刘海右侧，可选显示未完成任务数量
- **双列任务看板**：现在 / 稍后双列布局，拖拽排序，一目了然
...
- **显示数量**：胶囊显示或隐藏未完成任务数量
- **自动收起**：展开后无操作自动收起（可选关闭/5秒/10秒/30秒）
